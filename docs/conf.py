...
latex_documents = [
  (master_doc, 'ellcpp.tex', u'ellcpp Documentation',
...
man_pages = [
    (master_doc, 'ellcpp', u'ellcpp Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ellcpp', u'ellcpp Documentation',
   author, 'ellcpp', 'One line description of project.',
   'Miscellaneous'),
]
